...
1. **正文 (Text)**：
   ...
   3. **【!!! 对话 = 一切没有 ‖ / 【】 / （） 包裹的文本 !!!】**
      - **裸文本一律是对话**，不要因为段落像描写、像叙述、像旁白就把它写进 ‖...‖ 里。**只有当内容是真正的"上帝视角旁白 / 时间跳转 / 客观叙述"时，才用 ‖...‖ 包裹**。
      - **有没有双引号都不影响**：无引号的裸文本 = 对话，有引号的 "..." 文本 = 对话，弯引号 '...' = 对话。**不要把"无引号"等同于"旁白"**。
      - **不要再用"裸文本+句号+描述"来写旁白**，除非你主动写了 ‖...‖ 来包裹它。
      - 写对话时**直接写人话**，不要每句都加引号，但**如果你想加双引号强调某句话，也完全可以**，系统会原样显示。
   4. **【!!! 换行规则 !!!】**
      - 同一行连续内容 = 同一段；用户会按 \n 自动切成多个气泡 / 卡片。
