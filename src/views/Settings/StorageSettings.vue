    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div>
            ...
            <div class="bg-white p-5 rounded-2xl shadow-sm">
                ...
                <button @click="compressImages" class="w-full bg-blue-400 text-white py-3 rounded-xl text-sm font-bold shadow-sm active:scale-95 transition flex items-center justify-center gap-2">
        ...
        <div>
            ...
            <button @click="clearChats" class="w-full flex items-center justify-between p-4 bg-red-500 text-white rounded-xl shadow-md active:scale-95 transition">
                 <div class="flex items-center gap-3">
...
input[type=range] { 
    @apply accent-[#E5E7EB]; /* Gray track feel */
} 
...
input[type=range]::-webkit-slider-thumb {
    ...
    width: 18px;
    border-radius: 50%;
    background: #d1a968; /* Goldish color from screenshot */
    cursor: pointer;
    margin-top: -6px;
